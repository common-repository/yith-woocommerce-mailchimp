...
jQuery( function( $ ){
    ...
    // add updater button
    list_select.parent().append( $( '<a/>', { class: 'button button-secondary ajax-mailchimp-updater ajax-mailchimp-updater-list', id: 'yith_wmcm_mailchimp_list_updater', href: '#', text: yith_wcmc.labels.update_list_button } ) );
    group_select.parent().append( $( '<a/>', { class: 'button button-secondary ajax-mailchimp-updater ajax-mailchimp-updater-group', id: 'yith_wcmc_mailchimp_group_updater', href: '#', text: yith_wcmc.labels.update_group_button } ) );
    field_select.parent().append( $( '<a/>', { class: 'button button-secondary ajax-mailchimp-updater ajax-mailchimp-updater-field', id: 'yith_wcmc_mailchimp_field_updater', href: '#', text: yith_wcmc.labels.update_field_button } ) );

    var handle_lists = function( ev ){
            var t = $(this),
                list = t.parent().find( 'select' ),
